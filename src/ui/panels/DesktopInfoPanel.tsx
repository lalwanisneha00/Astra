 ...
 *
 * Desktop-only — see `InfoPanel.tsx` for the mobile/desktop switch and
 * `MobileInfoSheet.tsx` for the bottom-sheet equivalent used below the
 * `md` breakpoint. This file is otherwise unchanged from before that
 * split.
 */
